...
(function(window, undefined){
	...
	{
		console.log("🚀 ~ file: code.js:55 ~ privateEncodeTextField:")
		return "q;" + question;
	}
	
	function privateEncodeDropDownField(question, items)
	{
		console.log("🚀 ~ file: code.js:61 ~ privateEncodeDropDownField:")
	...
	String.prototype.replaceAll = function(search, replacement) {
		console.log("🚀 ~ file: code.js:74 ~ replaceAll:")
		var target = this;
    ...
    window.Asc.plugin.init = function()
    {
		...
		{
			console.log("🚀 ~ file: code.js:87 ~ buttonAddTextField:")
			if (_Control)
				return;
		...
		{
			console.log("🚀 ~ file: code.js:111 ~ buttonAddDropDownField:")
			if (_Control)
				return;
		...
		{
			console.log("🚀 ~ file: code.js:149 ~ buttonDropDownAddItem:")
		...
		{
			console.log("🚀 ~ file: code.js:164 ~ buttonDropDownRemoveItem:")
			var _select = document.getElementById("selectDropDown");
	...
	window.Asc.plugin.onMethodReturn = function(returnValue)
	{
		...
		{
			console.log("🚀 ~ file: code.js:168 ~ AddContentControl:")
			if (!returnValue)
			{
				console.log("🚀 ~ file: code.js:182 ~ returnValue:Content control not inserted")
				console.warn("Content control not inserted");
			}
			else if (_Control)
			{
				console.log("🚀 ~ file: code.js:187 ~ _Control:")
				if (1 === _Control.Type)
				{					
					console.log("🚀 ~ file: code.js:182 ~ returnValue:_Control.Type 1");
					var _obj = privateCreateScript(privateEncodeTextField(_Control.Question), _Control.Label, true, returnValue.InternalId);
					console.log("🚀 ~ file: code.js:182 ~ privateEncodeTextField:",_obj)
					window.Asc.plugin.executeMethod("InsertAndReplaceContentControls", [[_obj]]);
				}
				else if (2 === _Control.Type)
				{				
					console.log("🚀 ~ file: code.js:182 ~ returnValue:_Control.Type 2");
